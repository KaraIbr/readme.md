...
import { PVSystemFields } from '../components/PVSystemFields'
...
export function Component() {
  ...
  const { register, watch, handleSubmit, formState: { errors, isSubmitting } } = useForm<ProposalCreateFormData>({
  ...
  async function onSubmit(data: ProposalCreateFormData) {
  ...
  return (
    <div>
      <PageHeader title="New Proposal" description="Create a new commercial proposal" />
        ...
        <div className="bg-white rounded-xl border border-border p-6">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex justify-center gap-3 pt-4">
              <Button type="button" variant="secondary" onClick={() => navigate('/proposals')}>Cancel</Button>
              <Button type="submit" loading={isSubmitting || createProposal.isPending}>Create Proposal</Button>
            </div>
          </form>
        </div>
      </div>
...
Component.displayName = 'ProposalCreatePage'
